...
classifiers= [
    ...
    ('LogisticRegression(n_jobs=threads, class_weight="balanced", penalty="l2", multi_class="auto", solver="lbfgs")', LogisticRegression(n_jobs=threads, class_weight="balanced", penalty="l2", max_iter=2000, multi_class="auto", solver="lbfgs")),
